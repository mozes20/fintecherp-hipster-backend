...
public class TimesheetekResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<TimesheetekDTO> createTimesheetek(@Valid @RequestBody TimesheetekDTO timesheetekDTO)
    ...
    public ResponseEntity<TimesheetekDTO> updateTimesheetek(
            ...
            @Valid @RequestBody TimesheetekDTO timesheetekDTO) throws URISyntaxException {
    ...
    public ResponseEntity<TimesheetekDTO> partialUpdateTimesheetek(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody TimesheetekDTO timesheetekDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<TimesheetekDTO>> getAllTimesheeteks(
        ...
        LOG.info("🔍 Authentication objektum: {}",
        ...
        LOG.info("🔐 Felhasználó: {}, Admin: {}, AuthoritiesConstants.ADMIN={}",
                currentUserLogin, isAdmin, AuthoritiesConstants.ADMIN);

        // Ha nem admin, csak a saját timesheet-eket láthatja
        if (!isAdmin) {
            if (currentUserLogin.equals("anonymous")) {
                throw new BadRequestAlertException("Nem sikerült azonosítani a felhasználót", ENTITY_NAME,
                        "usernotfound");
            }
            ...
            LOG.info("📝 Frontend által küldött criteria (userLogin filter): {}",
        ...
        LOG.info("📦 getAllTimesheeteks() válasz - elemek száma: {}, teljes: {}",
    ...
    public ResponseEntity<List<TimesheetekDTO>> getTimesheeteksByMonth(
        ...
        try {
            ...
            throw new BadRequestAlertException("Invalid yearMonth format. Expected YYYY-MM", ENTITY_NAME,
                    "invalidformat");
        }
        ...
        String currentUserLogin = SecurityUtils.getCurrentUserLogin()
                .orElseThrow(() -> new BadRequestAlertException("Nem sikerült azonosítani a felhasználót", ENTITY_NAME,
                        "usernotfound"));
        boolean isAdmin = SecurityUtils.hasCurrentUserThisAuthority(AuthoritiesConstants.ADMIN);
    ...
    public ResponseEntity<List<TimesheetekDTO>> getMyTimesheets(
            @org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        LOG.info("📦 Visszaadott elemek száma: {}, Teljes találat: {}",
                page.getContent().size(),
                page.getTotalElements());
    ...
    public ResponseEntity<Integer> submitTimesheetsForMonth(@PathVariable String yearMonth) {
        ...
        LOG.info("✅ Beküldve jóváhagyásra: {} darab timesheet (felhasználó: {}, hónap: {})",
                updatedCount, currentUserLogin, yearMonth);

        return ResponseEntity.ok()
                .headers(HeaderUtil.createAlert(applicationName,
                        "timesheetekApp.timesheetek.submitted",
    ...
    public ResponseEntity<Integer> approveTimesheetsForUserAndMonth(
            @PathVariable String yearMonth,
        ...
        LOG.info("✅ Jóváhagyva: {} darab timesheet (felhasználó: {}, hónap: {})",
                approvedCount, userLogin, yearMonth);

        return ResponseEntity.ok()
                .headers(HeaderUtil.createAlert(applicationName,
                        "timesheetekApp.timesheetek.approved",
    ...
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<Integer> rejectTimesheetsForUserAndMonth(
            @PathVariable String yearMonth,
            @PathVariable String userLogin) {
        ...
        LOG.info("❌ Visszautasítva: {} darab timesheet (felhasználó: {}, hónap: {})",
                rejectedCount, userLogin, yearMonth);

        return ResponseEntity.ok()
                .headers(HeaderUtil.createAlert(applicationName,
                        "timesheetekApp.timesheetek.rejected",
