...
public class WorkingDayTemplateResource {
    ...
    public ResponseEntity<WorkingDayTemplateDTO> createWorkingDayTemplate(
        ...
        if (workingDayTemplateDTO.getId() != null) {
            throw new BadRequestAlertException("A new workingDayTemplate cannot already have an ID", ENTITY_NAME,
                    "idexists");
        }
        ...
        return ResponseEntity.created(new URI("/api/working-day-templates/" + workingDayTemplateDTO.getId()))
                .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME,
                        workingDayTemplateDTO.getId().toString()))
    ...
    public ResponseEntity<WorkingDayTemplateDTO> updateWorkingDayTemplate(
            ...
            @Valid @RequestBody WorkingDayTemplateDTO workingDayTemplateDTO) throws URISyntaxException {
    ...
    public ResponseEntity<WorkingDayTemplateDTO> partialUpdateWorkingDayTemplate(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody WorkingDayTemplateDTO workingDayTemplateDTO) throws URISyntaxException {
    ...
    public ResponseEntity<WorkingDayTemplateDTO> getWorkingDayTemplateByMonth(
