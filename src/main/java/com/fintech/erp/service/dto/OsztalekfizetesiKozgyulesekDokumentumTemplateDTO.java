...
/**
 * A DTO for the {@link com.fintech.erp.domain.OsztalekfizetesiKozgyulesekDokumentumTemplate} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OsztalekfizetesiKozgyulesekDokumentumTemplateDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OsztalekfizetesiKozgyulesekDokumentumTemplateDTO)) {
            return false;
        }
        OsztalekfizetesiKozgyulesekDokumentumTemplateDTO other = (OsztalekfizetesiKozgyulesekDokumentumTemplateDTO) o;
        if (this.id == null) {
            return false;
        }
    ...
    public String toString() {
        return (
            "OsztalekfizetesiKozgyulesekDokumentumTemplateDTO{" +
            "id=" +
            getId() +
            ", templateNev='" +
            getTemplateNev() +
