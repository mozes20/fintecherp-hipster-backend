...
/**
 * Criteria class for the {@link com.fintech.erp.domain.SajatCegKepviselok} entity. This class is used
 * in {@link com.fintech.erp.web.rest.SajatCegKepviselokResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sajat-ceg-kepviseloks?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SajatCegKepviselokCriteria implements Serializable, Criteria {
    ...
    public SajatCegKepviselokCriteria() {}

    public SajatCegKepviselokCriteria(SajatCegKepviselokCriteria other) {
    ...
    @Override
    public SajatCegKepviselokCriteria copy() {
        return new SajatCegKepviselokCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SajatCegKepviselokCriteria that = (SajatCegKepviselokCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, statusz, sajatCegId, maganszemelyId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "SajatCegKepviselokCriteria{" +
