...
public class TimesheetekService {
    ...
    public TimesheetekDTO save(TimesheetekDTO timesheetekDTO) {
        ...
        LOG.info("📝 Mentésre kerülő adatok: datum={}, userLogin={}, oraMennyiseg={}, statusz={}, megjegyzes={}", 
        ...
        LOG.info("✅ Elmentett adatok: id={}, datum={}, userLogin={}, oraMennyiseg={}", 
            savedDTO.getId(), 
            savedDTO.getDatum(), 
    ...
    public TimesheetekDTO update(TimesheetekDTO timesheetekDTO) {
        ...
        Timesheetek existing = timesheetekRepository.findById(timesheetekDTO.getId())
